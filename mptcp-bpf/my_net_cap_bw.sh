...
$NS_BR tc qdisc add dev ethBr1   root handle 1:0    netem delay 40ms
$NS_BR tc qdisc add dev ethBr1   parent 1:1 handle 10:    tbf rate 40Mbit latency 1ms burst 10000

$NS_BR tc qdisc add dev ethBr3   root handle 1:0    netem delay 40ms
$NS_BR tc qdisc add dev ethBr3   parent 1:1 handle 10:    tbf rate 40Mbit latency 1ms burst 10000

# for server-to-client traffic
$NS_BR tc qdisc add dev ethBr2   root handle 1:0    netem delay 40ms
$NS_BR tc qdisc add dev ethBr2   parent 1:1 handle 10:    tbf rate 40Mbit latency 1ms burst 10000
